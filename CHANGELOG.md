...
- **Pre-release container workflow with RC smoke tests** — comprehensive integration testing for release candidates (#1141, #1142, #1143)
...
- **Similar books 422 regression** — corrected error when books have chunks but no embeddings (#1226)
- **Thumbnails served from correct volume and URL path** — resolved volume mounting and URL path issues (#1139)
