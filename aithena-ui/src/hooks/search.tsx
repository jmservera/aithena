...
export const useSearch = () => {
  ...
  const search = useCallback(async (query: string, limit = 10) => {
    ...
    try {
      ...
      // `total` is the authoritative count from the API; fall back to the
      // results array length when the search service omits it (e.g. during
      // early development before the FastAPI contract is finalised).
