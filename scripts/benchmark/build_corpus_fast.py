...
BOOKS = {
    "en": [
        ...
        1342, 84, 11, 98, 74, 76, 1661, 2701, 4300, 5200,
        345, 174, 2554, 1080, 1260, 1184, 219, 30, 1998, 203,
        768, 1399, 2591, 16328, 46, 1232, 7370, 25344, 7178,
        2148, 3207, 1952, 2097, 2600, 2413, 4517, 514, 766,
        1400, 1322, 244, 580, 786, 161, 158, 120, 730, 863,
        36, 105, 113, 159, 160, 164, 23, 41, 43, 45, 47,
        55, 67, 73, 79, 808, 818, 820, 821, 823, 824, 826,
        829, 830, 833, 844, 845, 852, 855, 883, 910, 921,
        928, 932, 935, 943, 946, 949, 951, 957, 963, 968,
    ],
    "fr": [
        # French public domain works
        13951, 17489, 4650, 14779, 5097, 3748, 14286, 17834,
        13846, 15621, 17235, 3160, 17154, 16816, 5765, 3074,
        4122, 7105, 2982, 16652, 14523, 7942, 18585, 17302,
        14672, 10133, 7399, 2413, 8129, 11568, 14280, 13804,
        16715, 17111, 6592, 11539, 6593, 6594, 6595, 6596,
        13852, 13853, 13854, 13855, 13856, 13857, 14022, 14023,
    ...
    "es": [
        ...
        15064, 15078, 15095, 15105, 15117, 15133, 16396, 16397,
        16398, 16399, 16400, 16401, 16402, 16403, 16404, 16405,
        14267, 14268, 14269, 14270, 14271, 14272, 14273, 14274,
        14275, 14276, 14277, 14278, 14279, 14281, 14282, 14283,
        14284, 14285, 14287, 14288, 14289, 14290, 14291, 14292,
    ...
    "ca": [
        ...
        43371, 43372, 43373, 43374, 43375, 43376, 43377,
        43378, 43379, 43380, 43381, 43382, 43383, 43384,
        # Also try some general Romance IDs that may have CA content
        55989, 55990, 55991, 55992, 55993, 55994, 55995,
    ],
}
...
def main():
    ...
    log.info("=== DONE ===")
    log.info("EN: %d  FR: %d  ES: %d  CA: %d  TOTAL: %d (%.1f MB)",
