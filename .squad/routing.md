...
|-----------|----------|----------|
| Architecture & design | Ripley | System design, service boundaries, tech decisions, code review |
| Python backend services | Parker | PDF processing, metadata extraction, file watcher, API endpoints, Docker services |
