...
- The production docker-compose.yml no longer includes the `docker/compose.dev-ports.yml` pattern. Use explicit `-f` flags to select dev or production configuration.
...
- `docs/test-reports/v1.5.0.md` — Smoke test and integration test results validating deployment procedures
